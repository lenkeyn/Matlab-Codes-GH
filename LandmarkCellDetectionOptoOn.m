function sData = LandmarkCellDetectionOptoOn(sData)
...
for k = 1:1:3 % run in each protocol
    ...
    for m = 1:1:3
        if m == 1
            LandmarkDetection.OptoOff.LandmarkCellsList = LandmarkCells.LandmarkCells(~isnan(LandmarkCells.LandmarkCells)); 
            LandmarkDetection.OptoOff.VelcroCellsList = LandmarkCells.VelcroCells(~isnan(LandmarkCells.VelcroCells)); 
            LandmarkDetection.OptoOff.HGSCellsList = LandmarkCells.HGSCells(~isnan(LandmarkCells.HGSCells));
        elseif m == 2
            LandmarkDetection.OptoOn.LandmarkCellsList = LandmarkCells.LandmarkCells(~isnan(LandmarkCells.LandmarkCells)); 
            LandmarkDetection.OptoOn.VelcroCellsList = LandmarkCells.VelcroCells(~isnan(LandmarkCells.VelcroCells)); 
            LandmarkDetection.OptoOn.HGSCellsList = LandmarkCells.HGSCells(~isnan(LandmarkCells.HGSCells));
        elseif m == 3
            LandmarkDetection.AfterOpto.LandmarkCellsList = LandmarkCells.LandmarkCells(~isnan(LandmarkCells.LandmarkCells)); 
            LandmarkDetection.AfterOpto.VelcroCellsList = LandmarkCells.VelcroCells(~isnan(LandmarkCells.VelcroCells)); 
            LandmarkDetection.AfterOpto.HGSCellsList = LandmarkCells.HGSCells(~isnan(LandmarkCells.HGSCells));
        end
    end
       
end

LandmarkDetection.Params.LandmarkArea = LandmarkArea; 
LandmarkDetection.Params.VelcroStart1 = VelcroStart1;
LandmarkDetection.Params.VelcroEnd1 = VelcroEnd1;
LandmarkDetection.Params.VelcroStart2 = VelcroStart2;
LandmarkDetection.Params.VelcroEnd2 = VelcroEnd2;
LandmarkDetection.Params.HGSStart1 = HGSStart1;
LandmarkDetection.Params.HGSEnd1 = HGSEnd1;
LandmarkDetection.Params.HGSStart2 = HGSStart2;
LandmarkDetection.Params.HGSEnd2 = HGSEnd2;
LandmarkDetection.Params.DiffVelcro = DiffVelcro;
LandmarkDetection.Params.DiffHGS = DiffHGS;
LandmarkDetection.Params.AllowedJitter = AllowedJitter; 
LandmarkDetection.Params.MinPeakDetection = MinPeakDetection;


LandmarkDetection.LandmarkCellinAllProt = intersect(intersect(LandmarkDetection.OptoOff.LandmarkCellsList,LandmarkDetection.OptoOn.LandmarkCellsList),LandmarkDetection.AfterOpto.LandmarkCellsList);%,MaoOpto.OptoAfter.PlaceCells);
LandmarkDetection.LandmarkCellinAnyProt = union(union(LandmarkDetection.OptoOff.LandmarkCellsList,LandmarkDetection.OptoOn.LandmarkCellsList),LandmarkDetection.AfterOpto.LandmarkCellsList);%,MaoOpto.OptoAfter.PlaceCells);
sData.imdata.MaoPC_Opto_dff.LandmarkCells = LandmarkDetection;
...
for k = 1:1:3 % run in each protocol
    ...
    for i = 1:1:sData.imdata.nROIs % search for place cells with one peak 
        if PCdff.Criteria123Passed(i) > 0 && ~any(LandmarkDetection.LandmarkCellinAnyProt==i)  % if the cell was a place cell but not a landmark cell
