function sData  = CaDataOptoSortingDeconvData2(sData) 
...
mkdir(strcat(sData.sessionInfo.savePath,'\Imaging'),'RoiActDeconv-Opto');
SavePath = strcat(sData.sessionInfo.savePath,'\Imaging\RoiActDeconv-Opto');
...
sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials = NaN(sData.imdata.nROIs,sData.behavior.meta.nBins);
sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials = NaN(sData.imdata.nROIs,sData.behavior.meta.nBins);
sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials = NaN(sData.imdata.nROIs,sData.behavior.meta.nBins);
...
for roi = 1:1:sData.imdata.nROIs
    ...
    %data = smoothdata(sData.imdata.binned.RoiDeconvolved{1,roi},2,'Gaussian',smoothingFactor);
    ...
    sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials(roi,:) = nanmean(OptoOffdata);
    sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials(roi,:) = nanmean(OptoOndata);
    sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials(roi,:) = nanmean(AfterOptodata);
    ...
    Cmax = max(max(data));
    Min = -Cmax/10;
    label = 'decovloved signal';
     
    max1 = max(sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials(roi,1:BinNu));
    max2 = max(sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials(roi,1:BinNu));
    max3 = max(sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials(roi,1:BinNu));
    %Ymax = 1.1*(max([max1,max2,max3])+0.001); 
    YmaxSingleTrials = max(max(sData.imdata.binned.RoiDeconvolved{1,roi}));
    ...
    plot(Xaxis,(-(sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials(roi,1:BinNu)*nTrials*nTrials/2)+nTrials),'Color',[1 1 1],'LineWidth',1.5) 
    ...
    plot(Xaxis,(-(sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials(roi,1:BinNu)*nTrials*nTrials/2)+nTrials),'Color',[1 1 1],'LineWidth',1.5) 
    line([optoStimStart optoStimStart],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; line([optoStimEnd optoStimEnd],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; 
    line([sData.imdata.cues.C1A sData.imdata.cues.C1A],[0 nTrials],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5); hold on; 
    line([sData.imdata.cues.C2A sData.imdata.cues.C2A],[0 nTrials],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5);  
    line([sData.imdata.cues.C3A sData.imdata.cues.C3A],[0 nTrials],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5); 
    ...
    plot(Xaxis,(-(sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials(roi,1:BinNu)*nTrials*nTrials/2)+nTrials),'Color',[1 1 1],'LineWidth',1.5) 
    %line([optoStimStart optoStimStart],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; line([optoStimEnd optoStimEnd],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; 
    line([sData.imdata.cues.C1A sData.imdata.cues.C1A],[0 nTrials],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5); hold on; 
    line([sData.imdata.cues.C2A sData.imdata.cues.C2A],[0 nTrials],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5);  
    line([sData.imdata.cues.C3A sData.imdata.cues.C3A],[0 nTrials],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5); 
    ...
    plot(Xaxis,sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials(roi,1:BinNu),'Color',[0 0 0],'LineWidth',1) %Xaxis,CADATA.Opto.ROIsMeanAct_OptoOffTrials(roi,1:BinNu)
    %line([optoStimStart optoStimStart],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; line([optoStimEnd optoStimEnd],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; 
    ...
    plot(Xaxis,sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials(roi,1:BinNu),'Color',[0 0 0],'LineWidth',1)  %Xaxis,CADATA.Opto.ROIsMeanAct_OptoOnTrials(roi,1:BinNu)
    line([optoStimStart optoStimStart],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; line([optoStimEnd optoStimEnd],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; 
    axis([0 160 0 Ymax]);
    xlabel('Position on Wheel (cm)','FontSize',12); ax = gca; ax.TickDir = 'out'; xticks([0,50,100,150]); ax.FontSize = 12;
    ylabel('Position tuning','FontSize',12);
    ...
    plot(Xaxis,sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials(roi,1:BinNu),'Color',[0 0 0],'LineWidth',1)   %Xaxis,CADATA.Opto.ROIsMeanAct_OptoAfterTrials(roi,1:BinNu)
    %line([optoStimStart optoStimStart],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; line([optoStimEnd optoStimEnd],[0 nTrials],'Color','red','LineStyle','-','LineWidth',1); hold on; 
    axis([0 160 0 Ymax]);
    xlabel('Position on Wheel (cm)','FontSize',12); ax = gca; ax.TickDir = 'out'; xticks([0,50,100,150]); ax.FontSize = 12;
    ylabel('Position tuning','FontSize',12);
    %title('After-Opto');
    FileName = strcat(sprintf('ROI-%d',roi),'-',label,'-opto-deconv'); 
...
Ymax = 1.2*max([nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials,1),nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials,1),nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials,1)]);
...
plot(Xaxis,nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials,1),'LineWidth',1) %Xaxis,CADATA.Opto.ROIsMeanAct_OptoOffTrials(roi,1:BinNu)
...
line([sData.imdata.cues.C3A sData.imdata.cues.C3A],[0 Ymax],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5); 
line([sData.imdata.cues.C4A sData.imdata.cues.C4A],[0 Ymax],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5);
plot(Xaxis,nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials,1),'LineWidth',1) %Xaxis,CADATA.Opto.ROIsMeanAct_OptoOffTrials(roi,1:BinNu)
...
line([sData.imdata.cues.C3A sData.imdata.cues.C3A],[0 Ymax],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5); 
line([sData.imdata.cues.C4A sData.imdata.cues.C4A],[0 Ymax],'Color',[0.8 0.8 0.8],'LineStyle','--','LineWidth',1.5);
plot(Xaxis,nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials,1),'LineWidth',1) %Xaxis,CADATA.Opto.ROIsMeanAct_OptoOffTrials(roi,1:BinNu)
%line([optoStimStart optoStimStart],[0 Ymax],'Color',[0.5 0.5 0.5],'LineStyle','-','LineWidth',1); hold on; line([optoStimEnd optoStimEnd],[0 Ymax],'Color',[0.5 0.5 0.5],'LineStyle','-','LineWidth',1); hold on; 
axis([0 160 0 Ymax]); % ceil(Ymax)
xlabel('Position on Wheel (cm)','FontSize',10); ax = gca; ax.TickDir = 'out'; xticks([0,50,100,150]); ax.FontSize = 10;
%ylabel('Position tuning','FontSize',12);
...
FileName = 'AllROIMeanActDeconv-opto'; 
savefig(fullfile(SavePath,FileName));
saveas(gcf,(fullfile(SavePath,[FileName '.jpg'])));

%mean activity of all ROIs Opto-off-on-after in one plot
figure('Color','white','Position',[100 100 400 300]);
plot(Xaxis,nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoOffTrials,1),'LineStyle','-','LineWidth',1.5) %Xaxis,CADATA.Opto.ROIsMeanAct_OptoOffTrials(roi,1:BinNu)
hold on
plot(Xaxis,nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoOnTrials,1),'LineStyle','-','LineWidth',1.5)
hold on
plot(Xaxis,nanmean(sData.imdata.binned.ROIsMeanActDeconv_OptoAfterTrials,1),'LineStyle','-','LineWidth',1.5)
hold on
...
FileName = 'AllROIMeanActDeconv-opto2'; 
savefig(fullfile(SavePath,FileName));
saveas(gcf,(fullfile(SavePath,[FileName '.jpg'])));
