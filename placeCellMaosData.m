function sData = placeCellMaosData(sData,type,InOutRatio,ReliabiliyIndex)
...
elseif type == 2
    mkdir(strcat(sData.sessionInfo.savePath,'\Imaging'),'MaoPlaceCells-FR');
    SavePath = strcat(sData.sessionInfo.savePath,'\Imaging\MaoPlaceCells-FR');
end
