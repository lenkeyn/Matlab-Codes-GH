...
% Settings:
DeleteLickBeforeCm = 0.2*157; % delete licks before 20% length of the track, because sometimes animals licks the reward later than RZ, and it would contaminate lick calculation
...
BinsToAdd = round(10/sData.behavior.meta.binSize) - 1; % 10 cm equals with that amount of bins
BinBeginning = round(50/sData.behavior.meta.binSize); 
