...
% calculate Bahavioral data from TDMS data  (generated by LabView) and save it to LVDATA file. From 2018.11.19. calculate lapstart when Water Valve opens (photodiode signal is not reliable)

%%% SET PARAMETERS:
% BinNu = 60; % Bin number ; I calculated with 60 bins in all recordings
% IsOpto = 0; % 0 or 1; Is this session an optically stimulated? 
...
%%% generate fake frame signal to be able to generate downsampled data even if there were no imaging, meaning no frame signal 
...
% TRIAL SORTING (optogenetic activation on or off)
