function sData  = CaDataAlignToStim(sData,FigVisible) 
...
% set
mkdir(strcat(sData.sessionInfo.savePath,'\Imaging'),'AlignToStim');
mkdir(strcat(sData.sessionInfo.savePath,'\Imaging\AlignToStim'),'ROIAct');
...
%create struct
sData.imdata.AlignedStim = struct;
