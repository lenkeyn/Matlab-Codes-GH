function sData = motionCorrVector(sData,filePath,savePath) % filePath: raw data recording folder, containing frameShifts.mat
...
%figure();
nTrials = sData.behavior.wheelLapImaging;
plotHeatBinCa(sData.imdata.binned.MotCorrBinned,sData.sessionInfo.fileID,1,'MotionCorrVector',sData.behavior.meta.binSize,sData.behavior.meta.nBins,nTrials,'on'); %plotHeatBinCa(data,fileID,roi,ylab,BinSize,nTrials,figure visibility)
caxis([0 inf]); hold on;
