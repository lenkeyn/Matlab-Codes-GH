...
% MOUSEINFO
mouseInfo.name = '8020';                                  % char      (REQUIRED) Mouse number according to lab convention
mouseInfo.dateOfBirth = '2018.12.16';                     % char      (REQUIRED) yyyy.mm.dd
mouseInfo.strain = 'C57BL/6J';                            % char      (REQUIRED) Strain of animal used. Be specific. 
mouseInfo.transgene = 'B6-PV-Cre';
mouseInfo.Ordered = 'https://www.jax.org/strain/017320';
mouseInfo.sex = 'female';                                 % char      (REQUIRED) Male or female
mouseInfo.SLCageNumber = 35870;                           % double    (Optional) Science linker cage number
mouseInfo.SLMouseNumber = 95555;                          % double    (Optional) Science Linker animal number
mouseInfo.SLMouseLitter = 12949;
...
mouseInfo.windowType = 'Halfmoon left'; 
...
mouseInfo.injectedVirusN1NumberOfSites = 7;                % double
