function sData = calcCaDataNori2(sData,VelMin,laserPower,waveLength,fovCoord,pmtGainGreen,IsDeconv,gol) 
...
% load metadata
sData.imdata.meta = loadImagingMetadataNoriMCFolder(List);
